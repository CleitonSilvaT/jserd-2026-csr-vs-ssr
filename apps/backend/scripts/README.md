...
**Nota:** Certifique-se de que ambos os servidores (backend na porta 3001 e frontend na porta 5500) estão rodando antes de executar os testes.

## Outputs

Os resultados são salvos em `data/results/` (na raiz do repo):
